import{fetchPlaceholders as c,getMetadata as m,sampleRUM as u}from"./aem.min.js";u("cwv");function p(){"serviceWorker"in navigator?navigator.serviceWorker.register("../scripts/serviceworker.min.js").then(e=>{console.log("Service Worker registered.",e)}).catch(e=>{console.log("Service Worker **not** registered",e)}):console.log("Service workers are not supported in this browser.")}function h(){const e=document.createElement("script");e.innerHTML=`// Google Tag Manager 
