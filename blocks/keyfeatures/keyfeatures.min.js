import{ctaClick as h,ctaClickInteraction as S,keyFeaturesInteraction as v}from"../../dl.js";import{autoLinkLangPath as q}from"../../scripts/aem.js";import{decoratePlaceholder as x,targetObject as w}from"../../scripts/scripts.js";export default async function _(e){e.innerHTML=await x(e);const i=[...e.children].map(r=>r),s=L(i),t=document.createElement("div");t.innerHTML=s,e.innerHTML="",e.append(t);try{featureDropDownClick(e),T(e),e.closest(".home-loans-products-wrapper.view-more-less-js")&&$(e)}catch(r){console.warn(r)}}function L(e){let[i,s,t,r,n,a,c,o,u,p,m,y,l,f,d,g]=e;i=i?.textContent?.trim()||"",s=s?.querySelector("div > div")||"",t=t?.querySelector("div > picture > img")?.src||"",r=r?.textContent.trim()||"",n=n?.querySelector("div > picture > img")?.src||"",a=a?.textContent?.trim()||"",c=c?.textContent?.trim()||"",o=o?.textContent?.trim()||"",u=u?.querySelector("div > picture > img")?.src||"",p=p?.querySelector("div > picture > img")?.src||"",y=y?.querySelector("div > div")||"",f=f?.querySelector("div > div")||"",g=g?.querySelector("div > div")||"",m=m?.querySelector("div > picture > img")?.src||"",l=l?.querySelector("div > picture > img")?.src||"",d=d?.querySelector("div > picture > img")?.src||"";const k=o?` 
