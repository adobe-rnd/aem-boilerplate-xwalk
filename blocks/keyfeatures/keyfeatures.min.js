import{ctaClick as g,ctaClickInteraction as S,keyFeaturesInteraction as h}from"../../dl.min.js";import"../../scripts/aem.min.js";import{decoratePlaceholder as q,targetObject as w}from"../../scripts/scripts.min.js";export default async function x(e){e.innerHTML=await q(e);const i=[...e.children].map(r=>r),s=_(i),t=document.createElement("div");t.innerHTML=s,e.innerHTML="",e.append(t);try{featureDropDownClick(e),I(e),e.closest(".home-loans-products-wrapper.view-more-less-js")&&$(e)}catch(r){console.warn(r)}}function _(e){let[i,s,t,r,n,a,c,o,u,p,m,y,l,f,d,v]=e;i=i?.textContent?.trim()||"",s=s?.querySelector("div > div")||"",t=t?.querySelector("div > picture > img")?.src||"",r=r?.textContent.trim()||"",n=n?.querySelector("div > picture > img")?.src||"",a=a?.textContent?.trim()||"",c=c?.textContent?.trim()||"",o=o?.textContent?.trim()||"",u=u?.querySelector("div > picture > img")?.src||"",p=p?.querySelector("div > picture > img")?.src||"",y=y?.querySelector("div > div")||"",f=f?.querySelector("div > div")||"",v=v?.querySelector("div > div")||"",m=m?.querySelector("div > picture > img")?.src||"",l=l?.querySelector("div > picture > img")?.src||"",d=d?.querySelector("div > picture > img")?.src||"";const k=o?` 
