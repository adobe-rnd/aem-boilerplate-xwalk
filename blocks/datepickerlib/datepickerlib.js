...
!(function (e, t) {
  ...
  return (function () {
    ...
    class T {
      ...
      _buildBaseHtml() {
        (this.$el = n({ className: `air-datepicker-body -${this.type}-`, innerHtml: M[this.type] })),
    ...
    class R {
        ...
        if (
          ...
          I(this, "setPosition", function (e) {
            ...
            if (a) r.$datepicker.style.cssText = "left: 50%; top: 50%";
              ...
              if (
                (h === l && h !== document.body && ((o = { top: r.$el.offsetTop, left: r.$el.offsetLeft, width: n.width, height: r.$el.offsetHeight }), (u = 0), (p = 0)),
                h !== l && h !== document.body)
              ) {
      ...
      _triggerOnSelect() {
        ...
        i.length && ((e = i.map(g)), (t = h ? (n ? s.dateFormat(e) : e.map((e) => s.dateFormat(e))) : e.map((e) => this.formatDate(e, s.dateFormat)))),
          a({ date: o ? e : e[0], formattedDate: o ? t : t[0], datepicker: this });
      }
