import{applyLoanNow as j,bannerClick as B,ctaClick as F,ctaClickInteraction as l,readMoreInteraction as G}from"../../dl.min.js";import{getMetadata as W}from"../../scripts/aem.min.js";import{targetObject as n,handleOpenFormOnClick as z}from"../../scripts/scripts.min.js";export function decorateButtons(...r){return r.map(e=>{const a=e.querySelector("a");return a?(a.classList.add("button"),a.parentElement.tagName==="EM"&&a.classList.add("secondary"),a.parentElement.tagName==="STRONG"&&a.classList.add("primary"),a.outerHTML):""}).join("")}function y(r){const e=document.createElement("a");return e.href=r.innerText.trim(),e}export function generateTeaserDOM(r,e){document.createElement("a").classList.add("null-dom");const[d,$,m,x,v,p,S,I,H,V,C,_,A,X,q,E,D,Y,T,N,w]=r,o=d.querySelector("picture"),L=$.querySelector("picture"),O=p.textContent.trim()!=="",g=C.querySelector("a")||y(C),u=q.querySelector("a")||y(q),h=T.querySelector("a")||y(T);g.innerHTML=H.innerHTML,u.innerHTML=A.innerHTML,h.innerHTML=D.innerHTML;let f;[...e].includes("original-img")?f=o?.querySelector("img")?.src&&o?.querySelector("img").src?` style='background-image:url(${o?.querySelector("img").src.split("?")[0]})' `:"":f=o?.querySelector("img")?.src&&o?.querySelector("img").src?` style='background-image:url(${o?.querySelector("img").src})' `:"";const P=w?.querySelector("img")?.src?` style='background-image:url(${w?.querySelector("img")?.src})' `:"";let k=f;n.isTab&&(k=P);const s=document.createRange().createContextualFragment(`
    <div class='background' ${k}'>
      ...
      <div class='foreground'>
        <div class='text'>
          ...
          <!-- <div class='short-description'>${O?p.innerHTML:v.innerHTML}</div>-->
