...
export let overlay, emiOverlay, elgOverlay, loaninnerform, bodyElement;
...
export function applyLoanFormClick() {
  ...
  if (loaninnerform) {
    ...
    function resetLoanForm() {
      ...
      let inputs = [loanProduct(), formLoanAmt(), cutomerName(), cutomerIncome(), formDobInput(), stateInput(), branchInput(), cutomerNo()];
