...
// V2 API URL
const leadAPIURL = 'https://campaignapi.piramalfinance.com/api/website/insert-lead-data';
...
export {
  accessTokenURL, generateOTPURL, otpTokenURL, smsURL, leadAPIURL, verifyOTPURL, resendOTPUrl, getWhatAPIAuthURL, getWhatAPIURL,
};
