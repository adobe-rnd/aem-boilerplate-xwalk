import{intertextLinkingInteraction as p}from"../../dl.min.js";import{setLocationObj as d}from"../moredetailsaddress/moredetailsaddress.min.js";export default function u(e){const{pagecontent:t,geoInfo:{location:c}}=d;if(!t)return!1;const s=t.split(" ").slice(0,14).join(" "),r=t.split(" ").slice(14,90).join(" "),i=t.split(" ").slice(90).join(" ");e.innerHTML=`
