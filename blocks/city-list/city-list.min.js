import{ctaClickInteraction as c}from"../../dl.min.js";import{fetchAPI as l,getProps as s,renderHelper as u}from"../../scripts/scripts.min.js";export default async function f(t){const[r]=s(t),e=await(await l("GET",r)).json(),a=u(e.data.sort((i,o)=>i.text<o.text?-1:i.text>o.text?1:0),`<div class="forName">
