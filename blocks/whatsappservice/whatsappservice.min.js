import{onloadLoginCall as F}from"./login.min.js;import{otpPopupCall as S}from"./otppopup.min.js;const W=t=>t?.querySelector("img")?.getAttribute("src"),e=t=>t?.textContent.trim(),a=t=>W(t)||e(t);function q(t,s){return e(t)!=="true"?"":`
