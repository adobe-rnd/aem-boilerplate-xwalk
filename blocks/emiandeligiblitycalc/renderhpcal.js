...
export function renderCalculatorData(currentEle, calType) {
  ...
  const calculators = currentEle.querySelector('.overlayDiv.show .homeloancalculator .calctabs').children;
...
function trackCalTabClick(currentEle, calType) {
  const mainComponent = currentEle.querySelector('.overlayDiv.show .homeloancalculator');
