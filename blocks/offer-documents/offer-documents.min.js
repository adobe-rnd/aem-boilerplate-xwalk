import{ctaClickInteraction as p}from"../../dl.min.js";import{getProps as v}from"../../scripts/scripts.min.js";export default function y(a){const[c,i,l,d,u,r,m,n]=v(a,{index:[3,7]});if(m==="secondary"){a.innerHTML=`
